	...
	<table border="1">
		...
		<c:forEach items="${itemList }" var="item">
			<tr class="record">
				...
				<td align="center"><a href="<c:url value='edit.html'><c:param name='itemId' value='${item.itemId }'></c:param></c:url>" >상품편집</a></td>
				<td align="center"><a href="<c:url value='confirm.html'><c:param name='itemId' value='${item.itemId }'></c:param></c:url>" >상품삭제</a></td>
			</tr>
		</c:forEach>
	</table>
</div>
